...
o2.d1,o2.d2,o2.d3,o2.d4,o2.d5,o2.d6,o2.d7,o2.d8,o2.d9,o2.d10,o2.d11,o2.d12,o2.d13,o2.d14,o2.d15,o2.d16,
o2.d17,o2.d18,o2.d19,o2.d20,o2.d21,o2.d22,o2.d25,o2.d26,o2.d27,o2.d28,o2.d29
 FROM (
select 
...
where  o2.month_fmt = '07' -- or 
-- o2.month_fmt = '08' -- or o2.month_fmt = '06'
)o3
order by o3.industry,o3.week1,o3.month_fmt desc
)o4
where o4.close < 50
-- and code = '603855'
...
-- 月拼接
SELECT * FROM (
SELECT industry,code, name,month_fmt,close,(
select 
case i1.month_fmt 
             when '01' then d4+d5+d6+d7+d8
						 when '06' then (select d31 from stock_history sh where DATE_FORMAT(sh.date_trade,'%m%d') = '0531' and sh.code=i1.code )+d1+d2+d3+d4
						 when '07' then d5+d6+d7+d8+d9
						 when '08' then d2+d3+d4+d5+d6
						 end week1 from (
select 
...
) i1 where i1.code =o4.code and month_fmt = '07' -- 手工選取月份


) week_rank,week1,week2,week3,week4 FROM (
SELECT * FROM (
SELECT o2.industry,o2.code, o2.name,o2.month_fmt,o2.close,
case o2.month_fmt 
             when '01' then d4+d5+d6+d7+d8
...
where  o2.month_fmt = '07' or o2.month_fmt = '08' -- or o2.month_fmt = '06'
)o3
order by o3.industry,o3.week1,o3.month_fmt desc
)o4
where o4.close < 50
)o5 order by o5.industry,o5.week_rank,o5.month_fmt desc
-- and code = '600734'